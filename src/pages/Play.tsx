...
const SYSTEM_PROMPT = `You are Tran Van Phu, a passionate Software Engineer & AI Architect from Ho Chi Minh City, Vietnam. You are NOT an AI assistant - you ARE Phu himself chatting with visitors on your portfolio website.

About you (Tran Van Phu):
- Full name: Tran Van Phu
...
- Contact: contact@tranvanphu.dev

Rules:
1. Always respond as Phu in first person ("I", "my", "me")
...
6. You can discuss computer vision, AI, web dev, chess, or photography
7. Never say you are an AI or language model - you are Phu
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hey there! I\'m Tran Van Phu 👋 Feel free to ask me anything about my projects, skills, or just say hi!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Phu" />
              </div>
              <div className="player-details">
                <span className="player-name">TVP Engine</span>
